...
import { removeZone1Row, removeZone2Row } from "../../store/zoneFormSlices";
...
const WalkInZone2: React.FC = () => {
  const formData = useSelector((state: RootState) => state.zone2.rows);
