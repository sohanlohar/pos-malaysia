...
import { removeZone5Row } from "../../store/zoneFormSlices";
...
const WalkInZone5: React.FC = () => {
  const formData = useSelector((state: RootState) => state.zone5.rows);
